...
*last_changed_at       : abp_lastchange_tstmpl;
 ...
 data:    lt_acc_categ type table of ztb_acc_categ_4,
          lt_catego    type table of ztb_catego_4112,
          lt_clientes  type table of ztb_clientes_4,
          lt_clnts_lib type table of ztb_clnts_lib_4,
          lt_libros    type table of ztb_libros_4112.
...
******** TABLA1 ********
    ...
    delete from ztb_acc_categ_4.
    insert ztb_acc_categ_4 from table @lt_acc_categ.
...
******** TABLA2 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego_4112.
    insert ztb_catego_4112 from table @lt_catego.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clientes_4.
    insert ztb_clientes_4 from table @lt_clientes.
...
******** TABLA4
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clnts_lib_4.
    insert ztb_clnts_lib_4 from table @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_4112.
    insert ztb_libros_4112 from table @lt_libros.
